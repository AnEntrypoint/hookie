...
export const styles = {
  ...
  toolbar: { display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 14px', backgroundColor: '#ffffff', borderBottom: '1px solid #f1f5f9', flexWrap: 'wrap' },
  toolbarButton: { padding: '7px 12px', backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '10px', cursor: 'pointer', fontSize: '1rem', color: '#1e293b', ...minTouchSize },
  separator: { width: '1px', height: '24px', backgroundColor: '#e2e8f0', margin: '0 8px' },
  select: { padding: '7px 12px', border: '1px solid #e2e8f0', borderRadius: '10px', fontSize: '0.875rem', backgroundColor: '#f8fafc', cursor: 'pointer', ...minTouchSize },
  ...
  emptyState: { padding: '48px 24px', textAlign: 'center', color: '#94a3b8', fontSize: '1rem', border: '2px dashed #cbd5e1', borderRadius: '16px', backgroundColor: '#f8fafc', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', minHeight: '400px', justifyContent: 'center' },
  ...
  quickAddButton: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px', padding: '12px 16px', backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '12px', cursor: 'pointer', transition: 'all 150ms', minWidth: '80px' },
  ...
  selectionInfo: { display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: '10px 14px', backgroundColor: '#dbeafe', borderTop: '1px solid #93c5fd', gap: '12px' },
